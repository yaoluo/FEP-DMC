...
############################################################################
# write the information about the parameter
...
if __name__ == '__main__':
   ...
   create_html_file(yaml_dict,input_data,html_path,fout_name,title,'qe2pert')
   
   fout_name = './mydoc_table_input_parameters_qe2pert.html'
   print('Generating '+fout_name+' ...')
   create_html_table(yaml_dict,input_data,html_path,fout_name,title,'qe2pert')
   ...
   print('Generating '+fout_name+' ...')
   create_html_file(yaml_dict,input_data,html_path,fout_name,title,'perturbo')
   
   fout_name = './mydoc_table_input_parameters_perturbo.html'
   print('Generating '+fout_name+' ...')
   create_html_table(yaml_dict,input_data,html_path,fout_name,title,'perturbo')

############################################################################
############################################################################

#
# The section for the input files html page generation
#
